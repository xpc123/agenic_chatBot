# -*- coding: utf-8 -*-
"""
Settings API v2 - 设置管理接口

端点:
- GET/POST/DELETE /settings/indexing/*  - 索引管理
- GET/POST/DELETE /settings/rules       - 规则管理
- GET/POST/PATCH/DELETE /settings/skills/* - 技能管理
- GET/POST/DELETE /settings/mcp/*       - MCP 服务器管理
- GET /settings/summary                 - 设置摘要
"""
...
from ...rag.workspace_indexer import get_workspace_indexer
...
async def sync_index(
    ...
    try:
        ...
        status = await indexer.index_workspace(
            force=config.force,
